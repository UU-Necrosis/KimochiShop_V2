<?php
// =====================================================================================
// FILE: includes/supply_product.php (Bản Vá Lỗi Triệt Để - Tương Thích Giao Diện Gốc)
// =====================================================================================
try {
...
<div class="p-1">
    <div class="text-start mb-4">
        ...
        <p class="text-body opacity-75 small">Cung ứng mặt hàng mới của bạn lên hệ thống cửa hàng Kimochi Shop đầy đủ hình ảnh và thông số</p>
    </div>

    <form action="uploads_products.php" method="POST" enctype="multipart/form-data">
        
        <div class="mb-3">
            <label class="form-label text-body small text-uppercase fw-bold">Tên mặt hàng <span class="text-danger">*</span></label>
            <input type="text" name="name" class="form-control input-custom" placeholder="Ví dụ: Đồng hồ Kimochi Luxury Edition V2" required>
        </div>
        
        <div class="mb-3">
            <label class="form-label text-body small text-uppercase fw-bold">Danh mục mặt hàng <span class="text-danger">*</span></label>
        ...
        <div class="mb-3">
            <label class="form-label text-body small text-uppercase fw-bold">Mô tả chi tiết sản phẩm <span class="text-danger">*</span></label>
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                <label class="form-label text-body small text-uppercase fw-bold">Giá bán (VNĐ) <span class="text-danger">*</span></label>
                <input type="number" name="price" class="form-control input-custom" placeholder="Nhập số tiền bán..." required min="1">
            </div>
            <div class="col-md-6 mb-3">
                <label class="form-label text-body small text-uppercase fw-bold">Số lượng nhập kho <span class="text-danger">*</span></label>
                <input type="number" name="stock" class="form-control input-custom" placeholder="Nhập số lượng tồn..." required min="0">
            </div>
        </div>

        <div class="mb-4">
            <label class="form-label text-body small text-uppercase fw-bold">Hình ảnh sản phẩm đại diện <span class="text-danger">*</span></label>
            <input type="file" name="product_image" class="form-control input-custom" accept="image/*" required>
            <div class="text-body opacity-50 small" style="font-size: 11px; margin-top: 6px;">
